...
const About = () => {
  return (
    ...
    <div className="bg-black text-white p-8 md:p-32 text-center flex flex-col justify-center relative overflow-hidden">
      ...
      <p className="about tracking-wide my-8 text-base md:text-lg leading-relaxed font-ClashDisplay text-center max-w-xs md:max-w-3xl mx-auto mb-8 px-6 md:px-0">
      FUSION'25 is a dynamic 3-day event held by IEEE SPS SBC MACE in collaboration with IEEE SPS Kerala Chapter. 
      ...
      interactive games for the thrill of it and cultural night to let loose. The most pivotal take away from the event is the invaluable 
